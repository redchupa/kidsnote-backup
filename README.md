...
대기 시간은 알림장 개수 + **사진 분량**에 따라 다릅니다 (보고서 1개당 사진 20장이면 약 1분):
...
워크플로 timeout은 **6시간**으로 설정돼 있어 1년치 초기 백업도 한 번에 끝납니다. 그 이후 정기적 추가 백업은 dedup 덕분에 새 알림장만 처리해서 보통 몇 분 안에 완료.

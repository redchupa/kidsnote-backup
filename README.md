...
키즈노트(어린이집 알림장 앱)에 매일 쌓이는 글과 사진을 **나의 노션 데이터베이스로 자동 백업**하는 도구입니다.
...
1년치(보통 300개 안팎)가 노션 DB 한 곳에 모입니다.
...
Progress   0.3% (1/342) | Notion +1 rid=1390908410 images=0/0
Progress   0.6% (2/342) | Notion +1 rid=1390273292 images=5/5
...
Progress 100.0% (342/342) | Notion +1 rid=1182164750 images=2/2
...
노션 무료 플랜은 파일당 5 MiB(약 5MB) 한도입니다. 코드가 자동으로:

1. EXIF 위치(GPS) 정보 제거
2. 1920px로 리사이즈
3. JPEG 품질 단계적 축소 (85 → 60)

키즈노트의 일반 iPhone/Android 사진(3~8MB)은 100% 통과합니다. 4K 영상 같은 거대 파일이 있으면 그것만 skip됩니다(에러 아님, 페이지는 정상 생성).
